...
class DuoWebMock(object):
    ...
    """
    def sign_request(self, skey, ikey, username): pass
    def verify_response(self, skey, sig_response): pass
...
class TestBase(unittest.TestCase, object):
    ...
    def setUp(self):
        ...
        provider.initialize_duo('test_ikey', 'test_skey', 'test_host')
...
class TestLoginUser(
    ...
    def test_post_checkid_setup_no_cookie(self):
        ...
        provider.duo_web.sign_request(
            'test_skey', 'test_ikey', mox.IgnoreArg()).AndReturn(
            'test_sig_request')
